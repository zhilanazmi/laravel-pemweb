            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('crud_table')): ?>
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="<?php echo e(route('meja.index')); ?>">All Tables</a></li>
                            <li><a href="<?php echo e(route('meja.create')); ?>">Create Table</a></li>
                        </ul>
                    </li>
                <?php endif; ?>
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('crud_menu')): ?>
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            <li><a href="<?php echo e(route('menu.index')); ?>">All Menu's</a></li>
                            <li><a href="<?php echo e(route('menu.create')); ?>">Create Menu</a></li>
                        </ul>
                    </li>
                <?php endif; ?>
...
</div><?php /**PATH C:\Users\Lenovo\Documents\Tugas Kuliah\PEMWEB\TUGASBESAR\final-project\resources\views/page/includes/sidebar.blade.php ENDPATH**/ ?>